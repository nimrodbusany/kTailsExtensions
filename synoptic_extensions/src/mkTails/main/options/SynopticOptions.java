package synopticdynamic.main.options;
...
public class SynopticOptions extends Options {
    ...
    // //////////////////////////////////////////////////
    /**
     * Dump the complete list of mined synopticdynamic.invariants for the set of input
    ...
    /**
     * Run all tests in synopticdynamic.tests.units -- all the unit tests, and then
    ...
    /**
     * Run all tests in synopticdynamic.tests -- unit and integration tests, and then
     * terminate. This option is <i>unpublicized</i>; it will not appear in the
     * default usage message
     */
     ...
     * printing the list of mined synopticdynamic.invariants (using the option
