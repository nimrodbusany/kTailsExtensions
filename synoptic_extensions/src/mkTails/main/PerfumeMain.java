...
import synopticdynamic.main.options.PerfumeOptions;
...
public class PerfumeMain extends AbstractMain {
    ...
    /**
     * The synopticdynamic.main method to perform the Perfume inference algorithm. See
    ...
    public PerfumeMain(AbstractOptions opts,
        ...
        if (AbstractMain.instance != null) {
            throw new RuntimeException(
                    "Cannot create multiple instance of singleton synopticdynamic.main.AbstractMain");
        }
        this.options = opts;
