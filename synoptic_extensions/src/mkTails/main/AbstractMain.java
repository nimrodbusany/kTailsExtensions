...
import synopticdynamic.algorithms.Bisimulation;
import synopticdynamic.invariants.BinaryInvariant;
import synopticdynamic.invariants.ITemporalInvariant;
import synopticdynamic.invariants.TemporalInvariantSet;
import synopticdynamic.invariants.concurrency.NeverConcurrentInvariant;
import synopticdynamic.invariants.constraints.TempConstrainedInvariant;
import synopticdynamic.invariants.miners.ChainWalkingTOInvMiner;
import synopticdynamic.invariants.miners.DAGWalkingPOInvMiner;
import synopticdynamic.invariants.miners.IPOInvariantMiner;
import synopticdynamic.invariants.miners.ITOInvariantMiner;
import synopticdynamic.invariants.miners.TransitiveClosureInvMiner;
import synopticdynamic.main.options.AbstractOptions;
import synopticdynamic.main.options.Options;
import synopticdynamic.main.parser.ParseException;
import synopticdynamic.main.parser.TraceParser;
import synopticdynamic.model.ChainsTraceGraph;
import synopticdynamic.model.DAGsTraceGraph;
import synopticdynamic.model.EventNode;
import synopticdynamic.model.PartitionGraph;
import synopticdynamic.model.Trace;
import synopticdynamic.model.Transition;
import synopticdynamic.model.event.Event;
import synopticdynamic.model.event.EventType;
import synopticdynamic.model.export.DotExportFormatter;
import synopticdynamic.model.export.GmlExportFormatter;
import synopticdynamic.model.export.GraphExportFormatter;
import synopticdynamic.model.export.GraphExporter;
import synopticdynamic.model.export.JsonExporter;
import synopticdynamic.model.export.LtsExporter;
import synopticdynamic.model.interfaces.IGraph;
import synopticdynamic.model.interfaces.INode;
import synopticdynamic.model.interfaces.IRelationPath;
import synopticdynamic.model.testgeneration.AbstractTestCase;
import synopticdynamic.tests.SynopticLibTest;
import synopticdynamic.util.BriefLogFormatter;
import synopticdynamic.util.SynopticJar;
...
public abstract class AbstractMain {
    ...
    public static GraphExportFormatter processArgs(AbstractOptions options)
        ...
        if (options.runAllTests) {
            List<String> testClasses = SynopticJar
                    .getTestsInPackage("synopticdynamic.tests.units.");
            testClasses.addAll(SynopticJar
                    .getTestsInPackage("synopticdynamic.tests.integration."));
    ...
    public void runSynoptic(PartitionGraph pGraph) {
        ...
        // TODO: check that none of the initially mined synopticdynamic.invariants are
