package synopticdynamic.benchmarks;

import java.util.Collection;
import java.util.LinkedHashMap;

/**
 * A class to facilitate synopticdynamic.benchmarks. Just set your benchmark up as a
 * ConfigureableBenchmark, and pass it to the constructor. The
 * synopticdynamic.benchmarks can be run by passing the configuration arguments to run.
...
public class Benchmark<ArgumentType> {
    ...
    /**
     * The factory that creates the actual synopticdynamic.benchmarks from the configs.
     */
     ...
     * @param taskFactory
     *            the taskFactory that creates synopticdynamic.benchmarks from
    ...
    /**
     * Run the synopticdynamic.benchmarks for each arg in arguments.
     * 
     * @param arguments
