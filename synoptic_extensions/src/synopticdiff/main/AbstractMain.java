...
import synopticdiff.algorithms.Bisimulation;
...
import synopticdiff.invariants.concurrency.NeverConcurrentInvariant;
import synopticdiff.invariants.constraints.TempConstrainedInvariant;
import synopticdiff.invariants.miners.ChainWalkingTOInvMiner;
import synopticdiff.invariants.miners.DAGWalkingPOInvMiner;
import synopticdiff.invariants.miners.IPOInvariantMiner;
import synopticdiff.invariants.miners.ITOInvariantMiner;
import synopticdiff.invariants.miners.TransitiveClosureInvMiner;
...
import synopticdiff.model.Trace;
...
import synopticdiff.model.export.GmlExportFormatter;
import synopticdiff.model.export.GraphExportFormatter;
import synopticdiff.model.export.GraphExporter;
import synopticdiff.model.export.JsonExporter;
import synopticdiff.model.export.LtsExporter;
import synopticdiff.model.interfaces.IGraph;
import synopticdiff.model.interfaces.INode;
import synopticdiff.model.interfaces.IRelationPath;
import synopticdiff.model.testgeneration.AbstractTestCase;
import synopticdiff.tests.SynopticLibTest;
import synopticdiff.util.BriefLogFormatter;
import synopticdiff.util.SynopticJar;
...
public abstract class AbstractMain {
    ...
    public static GraphExportFormatter processArgs(AbstractOptions options)
        ...
        if (options.runAllTests) {
            List<String> testClasses = SynopticJar
                    .getTestsInPackage("synopticdiff.tests.units.");
            testClasses.addAll(SynopticJar
                    .getTestsInPackage("synopticdiff.tests.integration."));
    ...
    public void runSynoptic(PartitionGraph pGraph) {
        ...
        // TODO: check that none of the initially mined synopticdiff.invariants are
