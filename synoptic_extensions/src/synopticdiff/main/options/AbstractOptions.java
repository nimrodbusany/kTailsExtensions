...
public class AbstractOptions {
    ...
    static final String runTestsStr = "Run all tests in synopticdiff.tests.units, and then terminate.";
    public boolean runTests = false;

    static final String runAllTestsStr = "Run all tests in synopticdiff.tests, and then terminate.";
