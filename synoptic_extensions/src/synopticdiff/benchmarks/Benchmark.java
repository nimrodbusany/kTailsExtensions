package synopticdiff.benchmarks;

import java.util.Collection;
import java.util.LinkedHashMap;

/**
 * A class to facilitate synopticdiff.benchmarks. Just set your benchmark up as a
 * ConfigureableBenchmark, and pass it to the constructor. The
 * synopticdiff.benchmarks can be run by passing the configuration arguments to run.
...
public class Benchmark<ArgumentType> {
    ...
    /**
     * The factory that creates the actual synopticdiff.benchmarks from the configs.
     */
     ...
     * @param taskFactory
     *            the taskFactory that creates synopticdiff.benchmarks from
    ...
    /**
     * Run the synopticdiff.benchmarks for each arg in arguments.
     * 
     * @param arguments
