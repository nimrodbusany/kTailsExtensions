...
import synopticdiff.invariants.fsmcheck.ConstrainedHistoryNode;
import synopticdiff.invariants.fsmcheck.ConstrainedTracingSet;
...
public class ConstrainedTracingSetTests extends PynopticTest {
	...
	protected String[]	eventsAFby		= { "x 0", "y 11", "z 71", "w 72",
			"--", "x 100", "y 160", "z 171", "w 172", "--", "v 200", "z 201",
			"w 202"					};
