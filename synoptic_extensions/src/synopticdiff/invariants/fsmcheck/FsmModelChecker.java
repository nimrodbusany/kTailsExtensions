package synopticdiff.invariants.fsmcheck;
...
import synopticdiff.invariants.AlwaysPrecedesInvariant;
import synopticdiff.invariants.BinaryInvariant;
import synopticdiff.invariants.CExamplePath;
import synopticdiff.invariants.ITemporalInvariant;
import synopticdiff.invariants.InterruptedByInvariant;
import synopticdiff.invariants.NeverFollowedInvariant;
import synopticdiff.invariants.constraints.IThresholdConstraint;
import synopticdiff.invariants.constraints.LowerBoundConstraint;
import synopticdiff.invariants.constraints.TempConstrainedInvariant;
import synopticdiff.invariants.constraints.UpperBoundConstraint;
import synopticdiff.model.interfaces.IGraph;
import synopticdiff.model.interfaces.INode;

/**
 * Implements two different finite-state-machine based synopticdiff.model checkers.
 * The first is implemented using bitsets, and therefore can evaluate many
 * synopticdiff.invariants at once in one relatively efficient pass. Following this
 * pass, a less efficient synopticdiff.model is invoked, which keeps track of the
...
public class FsmModelChecker {
    ...
    /**
     * Use the BitSet checker to evaluate, and return which synopticdiff.invariants
     * failed.
     */
    ...
    /**
     * Runs invariant-checking finite state machines over the synopticdiff.model
