package synopticdiff.invariants;
...
import synopticdiff.invariants.ltlchecker.GraphLTLChecker;
...
public class TemporalInvariantSet implements Iterable<ITemporalInvariant> {
    ...
    public String supportCountToPrettyString() {
        String ret = "";
        for (ITemporalInvariant inv : invariants) {
     ...
     */
    public void outputToFile(String fileName, boolean supportCount)
            throws FileNotFoundException {
