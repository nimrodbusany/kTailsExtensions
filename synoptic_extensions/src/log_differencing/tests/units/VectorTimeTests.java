...
import synopticdiff.util.time.NonComparableTimesException;
import synopticdiff.util.time.NotComparableVectorsException;
import synopticdiff.util.time.VectorTime;
import synopticdiff.util.time.WrongTimeTypeException;

/**
 * Tests for synopticdiff.model.input.VectorTime class.
 */
