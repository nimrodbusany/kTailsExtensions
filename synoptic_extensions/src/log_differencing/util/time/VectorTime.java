package synopticdiff.util.time;
...
public class VectorTime implements ITime {
     ...
     * (non-Javadoc)
     * 
     * @see synopticdiff.util.ITime#lessThan(synopticdiff.util.VectorTime)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see synopticdiff.util.ITime#hashCode()
     */
    @Override
    public int hashCode() {
        final int prime = 31;
     ...
     * (non-Javadoc)
     * 
     * @see synopticdiff.util.ITime#equals(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see synopticdiff.util.ITime#toString()
     */
    @Override
