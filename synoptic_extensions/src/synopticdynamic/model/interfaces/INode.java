package synopticdynamic.model.interfaces;
...
public interface INode<NodeType> extends Comparable<NodeType> {
	...
	/**
	 * Returns additional info for the label of the node.
	 * 
	 * @return more info on the node as string.
	 */
	String getAdditionalLableInfo();
	
	/**
	 * Returns additional attributes for the node.
	 * 
	 * @return more info on the node as string.
	 */
