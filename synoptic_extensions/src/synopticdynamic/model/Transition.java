...
import synopticdynamic.util.time.TimeSeries;
 ...
 * @param <NodeType>
 */
public class Transition<NodeType extends INode<NodeType>> implements
		ITransition<NodeType> {
	...
	private Transition(NodeType source, NodeType target) {
		...
		// EventNode src = (EventNode) this.source;
		// EventNode dst = (EventNode) this.target;
		//
		// this.log.add(Integer.toString(src.getTraceID()));
		// this.log.add(Integer.toString(dst.getTraceID()));
	...
	@Override
	public void setRealProbability(double fraction) {
...
//		System.out.println(this + "lable is " + labels + " res4 is " + result);
		return result;
	}
