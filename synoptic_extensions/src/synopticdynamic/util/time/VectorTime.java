package synopticdynamic.util.time;
...
public class VectorTime implements ITime {
     ...
     * (non-Javadoc)
     * 
     * @see synopticdynamic.util.ITime#lessThan(synopticdynamic.util.VectorTime)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see synopticdynamic.util.ITime#hashCode()
     */
    @Override
    public int hashCode() {
        final int prime = 31;
     ...
     * (non-Javadoc)
     * 
     * @see synopticdynamic.util.ITime#equals(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see synopticdynamic.util.ITime#toString()
     */
    @Override
