...
import synopticdynamic.invariants.CExamplePath;
...
import synopticdynamic.invariants.constraints.LowerBoundConstraint;
...
/**
 * Implements two different finite-state-machine based synopticdynamic.model checkers.
 * The first is implemented using bitsets, and therefore can evaluate many
 * synopticdynamic.invariants at once in one relatively efficient pass. Following this
 * pass, a less efficient synopticdynamic.model is invoked, which keeps track of the
...
public class FsmModelChecker {
    ...
    /**
     * Use the BitSet checker to evaluate, and return which synopticdynamic.invariants
     * failed.
     */
    ...
    /**
     * Runs invariant-checking finite state machines over the synopticdynamic.model
