 ...
 * synopticdynamic.model a set of states which can be inhabited (by some path from an
 * initial node).
 * </p>
 * <p>
 ...
 * binary synopticdynamic.invariants. In other words, each individual machine being
...
public abstract class FsmStateSet<T extends INode<T>> implements
     ...
     * passed synopticdynamic.invariants. NOTE: this assumes that all of the passed
     * synopticdynamic.invariants are of the appropriate type.
     */
     ...
     * traces), this indicates which of the synopticdynamic.invariants maintained by
