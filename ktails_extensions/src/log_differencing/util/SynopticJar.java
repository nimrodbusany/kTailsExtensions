...
public class SynopticJar {
	 ...
	 * "log_differencing.tests.units"). This method can be used with Synoptic in a
	 * jar file (e.g., synoptic.jar), but also if Synoptic is not within a jar
	 * file. <br />
	 * <br/>
