package log_differencing.util.time;
...
public class VectorTime implements ITime {
     ...
     * (non-Javadoc)
     * 
     * @see log_differencing.util.ITime#lessThan(log_differencing.util.VectorTime)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see log_differencing.util.ITime#hashCode()
     */
    @Override
    public int hashCode() {
        final int prime = 31;
     ...
     * (non-Javadoc)
     * 
     * @see log_differencing.util.ITime#equals(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see log_differencing.util.ITime#toString()
     */
    @Override
