package log_differencing.model;
...
import log_differencing.util.Predicate.IBoolBinary;
...
public abstract class TraceGraph<EType extends EventType> implements
	...
	private boolean transitionEquality(EventNode a, EventNode b,
		...
		Stack<log_differencing.util.Pair<EventNode, EventNode>> toVisit = new Stack<log_differencing.util.Pair<EventNode, EventNode>>();
