...
import log_differencing.algorithms.Bisimulation;
import log_differencing.invariants.BinaryInvariant;
import log_differencing.invariants.ITemporalInvariant;
import log_differencing.invariants.TemporalInvariantSet;
import log_differencing.invariants.concurrency.NeverConcurrentInvariant;
import log_differencing.invariants.constraints.TempConstrainedInvariant;
import log_differencing.invariants.miners.ChainWalkingTOInvMiner;
import log_differencing.invariants.miners.DAGWalkingPOInvMiner;
import log_differencing.invariants.miners.IPOInvariantMiner;
import log_differencing.invariants.miners.ITOInvariantMiner;
import log_differencing.invariants.miners.TransitiveClosureInvMiner;
import log_differencing.main.options.AbstractOptions;
import log_differencing.main.options.Options;
...
import log_differencing.model.Trace;
...
import log_differencing.model.export.DotExportFormatter;
import log_differencing.model.export.GmlExportFormatter;
import log_differencing.model.export.GraphExportFormatter;
import log_differencing.model.export.GraphExporter;
import log_differencing.model.export.JsonExporter;
import log_differencing.model.export.LtsExporter;
import log_differencing.model.interfaces.IGraph;
import log_differencing.model.interfaces.INode;
import log_differencing.model.interfaces.IRelationPath;
import log_differencing.model.testgeneration.AbstractTestCase;
import log_differencing.tests.SynopticLibTest;
import log_differencing.util.BriefLogFormatter;
import log_differencing.util.SynopticJar;
...
public abstract class AbstractMain {
    ...
    public static GraphExportFormatter processArgs(AbstractOptions options)
        ...
        if (options.runAllTests) {
            List<String> testClasses = SynopticJar
                    .getTestsInPackage("log_differencing.tests.units.");
            testClasses.addAll(SynopticJar
                    .getTestsInPackage("log_differencing.tests.integration."));
    ...
    public void runSynoptic(PartitionGraph pGraph) {
        ...
        // TODO: check that none of the initially mined log_differencing.invariants are
