...
import log_differencing.main.options.PerfumeOptions;
...
public class PerfumeMain extends AbstractMain {
    ...
    /**
     * The log_differencing.main method to perform the Perfume inference algorithm. See
    ...
    public PerfumeMain(AbstractOptions opts,
        ...
        if (AbstractMain.instance != null) {
            throw new RuntimeException(
                    "Cannot create multiple instance of singleton log_differencing.main.AbstractMain");
        }
        this.options = opts;
