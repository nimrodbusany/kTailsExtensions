...
public class AbstractOptions {
    ...
    static final String runTestsStr = "Run all tests in log_differencing.tests.units, and then terminate.";
    public boolean runTests = false;

    static final String runAllTestsStr = "Run all tests in log_differencing.tests, and then terminate.";
