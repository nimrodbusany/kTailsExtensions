package log_differencing.main.options;
...
public class SynopticOptions extends Options {
    ...
    // //////////////////////////////////////////////////
    /**
     * Dump the complete list of mined log_differencing.invariants for the set of input
    ...
    /**
     * Run all tests in log_differencing.tests.units -- all the unit tests, and then
    ...
    /**
     * Run all tests in log_differencing.tests -- unit and integration tests, and then
     * terminate. This option is <i>unpublicized</i>; it will not appear in the
     * default usage message
     */
     ...
     * printing the list of mined log_differencing.invariants (using the option
