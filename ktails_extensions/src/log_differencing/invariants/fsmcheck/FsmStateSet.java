 ...
 * log_differencing.model a set of states which can be inhabited (by some path from an
 * initial node).
 * </p>
 * <p>
 ...
 * binary log_differencing.invariants. In other words, each individual machine being
...
public abstract class FsmStateSet<T extends INode<T>> implements
     ...
     * passed log_differencing.invariants. NOTE: this assumes that all of the passed
     * log_differencing.invariants are of the appropriate type.
     */
     ...
     * traces), this indicates which of the log_differencing.invariants maintained by
