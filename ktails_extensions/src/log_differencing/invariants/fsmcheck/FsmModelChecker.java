package log_differencing.invariants.fsmcheck;
...
import log_differencing.invariants.AlwaysFollowedInvariant;
import log_differencing.invariants.AlwaysPrecedesInvariant;
import log_differencing.invariants.BinaryInvariant;
import log_differencing.invariants.CExamplePath;
import log_differencing.invariants.ITemporalInvariant;
import log_differencing.invariants.InterruptedByInvariant;
import log_differencing.invariants.NeverFollowedInvariant;
import log_differencing.invariants.constraints.IThresholdConstraint;
import log_differencing.invariants.constraints.LowerBoundConstraint;
import log_differencing.invariants.constraints.TempConstrainedInvariant;
import log_differencing.invariants.constraints.UpperBoundConstraint;
...
/**
 * Implements two different finite-state-machine based log_differencing.model checkers.
 * The first is implemented using bitsets, and therefore can evaluate many
 * log_differencing.invariants at once in one relatively efficient pass. Following this
 * pass, a less efficient log_differencing.model is invoked, which keeps track of the
...
public class FsmModelChecker {
    ...
    /**
     * Use the BitSet checker to evaluate, and return which log_differencing.invariants
     * failed.
     */
    ...
    /**
     * Runs invariant-checking finite state machines over the log_differencing.model
