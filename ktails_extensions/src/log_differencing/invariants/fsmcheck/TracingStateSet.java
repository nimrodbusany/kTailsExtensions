 ...
 * being inhabited. This allows for log_differencing.model checking which yields short
 * counterexample paths for failing log_differencing.invariants.
 * 
 * @param <T>
