package log_differencing.benchmarks;

import java.util.Collection;
import java.util.LinkedHashMap;

/**
 * A class to facilitate log_differencing.benchmarks. Just set your benchmark up as a
 * ConfigureableBenchmark, and pass it to the constructor. The
 * log_differencing.benchmarks can be run by passing the configuration arguments to run.
...
public class Benchmark<ArgumentType> {
    ...
    /**
     * The factory that creates the actual log_differencing.benchmarks from the configs.
     */
     ...
     * @param taskFactory
     *            the taskFactory that creates log_differencing.benchmarks from
    ...
    /**
     * Run the log_differencing.benchmarks for each arg in arguments.
     * 
     * @param arguments
