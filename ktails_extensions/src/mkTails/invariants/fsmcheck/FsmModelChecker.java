package mkTails.invariants.fsmcheck;
...
import mkTails.invariants.CExamplePath;
...
import mkTails.invariants.constraints.IThresholdConstraint;
import mkTails.invariants.constraints.LowerBoundConstraint;
import mkTails.invariants.constraints.TempConstrainedInvariant;
import mkTails.invariants.constraints.UpperBoundConstraint;
...
/**
 * Implements two different finite-state-machine based mkTails.model checkers.
 * The first is implemented using bitsets, and therefore can evaluate many
 * mkTails.invariants at once in one relatively efficient pass. Following this
 * pass, a less efficient mkTails.model is invoked, which keeps track of the
...
public class FsmModelChecker {
    ...
    /**
     * Use the BitSet checker to evaluate, and return which mkTails.invariants
     * failed.
     */
    ...
    /**
     * Runs invariant-checking finite state machines over the mkTails.model
