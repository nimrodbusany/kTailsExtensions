package mkTails.benchmarks;

import java.util.Collection;
import java.util.LinkedHashMap;

/**
 * A class to facilitate mkTails.benchmarks. Just set your benchmark up as a
 * ConfigureableBenchmark, and pass it to the constructor. The
 * mkTails.benchmarks can be run by passing the configuration arguments to run.
...
public class Benchmark<ArgumentType> {
    ...
    /**
     * The factory that creates the actual mkTails.benchmarks from the configs.
     */
     ...
     * @param taskFactory
     *            the taskFactory that creates mkTails.benchmarks from
    ...
    /**
     * Run the mkTails.benchmarks for each arg in arguments.
     * 
     * @param arguments
