package mkTails.algorithms.graphops;
...
public class PartitionMultiSplit implements IOperation {
     ...
     *            the split that this multi split is based on.
     */
    public PartitionMultiSplit(Partition partitionTosplit, ArrayList<Set<EventNode>> partitioning) {
        partition = partitionTosplit;
        this.partitioning.addAll(partitioning);
    }
