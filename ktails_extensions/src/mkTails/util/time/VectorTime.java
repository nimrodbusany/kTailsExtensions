...
public class VectorTime implements ITime {
     ...
     * (non-Javadoc)
     * 
     * @see mkTails.util.ITime#lessThan(mkTails.util.VectorTime)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see mkTails.util.ITime#hashCode()
     */
    @Override
    public int hashCode() {
        final int prime = 31;
     ...
     * (non-Javadoc)
     * 
     * @see mkTails.util.ITime#equals(java.lang.Object)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see mkTails.util.ITime#toString()
     */
    @Override
